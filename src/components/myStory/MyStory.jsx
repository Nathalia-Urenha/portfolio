  ...
  return (
      ...
      <div className="left">
        <div className="wrapper">
          ...
          faculdades que eu conseguiria entrar, e lá estava o <span style={{fontWeight: 'bold', color: '#3fafaa'}}>IFSP  - campus Birigui</span>, que era o mais próximo de minha cidade. 
          ...
          Atualmente eu faço  estágio na empresa <span style={{fontWeight: 'bold', color: '#3fafaa'}}>Gorila Invest</span>, atuando como <span style={{fontWeight: 'bold', color: '#3fafaa'}}>desenvolvedora front-end</span>, entrei nesse estágio em 
